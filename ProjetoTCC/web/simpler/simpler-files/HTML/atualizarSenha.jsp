            ...
            <div class="wrapper clearfix">
                ...
                <div id="page-content" class="clearfix">
                    ...
                    <div class="left-page-block">
                        <h4 class="heading">Atualizar senha</h4>
                        <!-- form -->
                        <%
                            ...
                            if (request.getParameter("senha") != null) {
                                ...
                                if (senha.equals(confirmar)) {
                                    ...
                                    UsuarioVO user = controle.pesquisarUsuario(email);
                                    if (user.getPassword().equals(Criptografia.criptografiaSHA256(senha))) {
                                        out.print("<p>Digite uma senha diferente da anterior</p>");
                                    } else {
                                        String res = controle.alterarSenha(email, Criptografia.criptografiaSHA256(senha));
                                        if (res == null) {
                                            out.print("<p>Senha atualizada com sucesso</p>");
                                        } else {
                                            out.print(res);
                                        }
                                    }
                                } else {
                                    out.print("<p>Senhas são diferentes</p>");
                                }
                            }
                        %>
                        <form method="post" action="#">
                            <p>Digite a nova senha:&nbsp;&nbsp;<input type="password" size="20" name="senha" required></p>
                            <p>Confirme a nova senha:&nbsp;&nbsp;<input type="password" size="20" name="confirmar" required></p>
