                        ...
                        <form method='post' action='atualizarDados.jsp'>
                            <%
                                ...
                                if (request.getParameter("nome") == null) {
                                    ...
                                    if (resultado == null) {
                                        out.println("</p>Atualização realizada com sucesso !</p>");
                                    } else {
                                ...
                                out.println("Selecione o seu módulo: ");
                                out.println("<select name='modulo'>");
                                for (int i = 1; i <= 6; i++) {
                                    if (i == user.getModulo()) {
                                        out.println("<option value='" + i + "' selected>" + i + "° Módulo</option>");
                                    } else {
                                        out.println("<option value='" + i + "'>" + i + "° Módulo</option>");
                                    }
                                }
                                out.println("</p><br>");
                            %>
